...
//       case "creator":
//         return [
//           { name: "Creator Dashboard", href: "/dashboard/creator", icon: FaHome },
...
//       {/* Sidebar */}
//       <aside
//         className={`fixed left-0 top-0 h-full  shadow-xl transition-all duration-300 z-40
...
//                 {isCollapsed && (
//                   <span className="absolute left-20 bg-gray-900 text-white text-sm px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
//                     {item.name}
//                   </span>
//                 )}
//               </Link>
...
//       {/* Sidebar - Glass effect with dark background matching your theme */}
//       <aside
//         className={`
...
//         {/* <div className={`p-6 border-b border-purple-500/20 ${isCollapsed ? "px-4" : ""}`}>
//           <Link href="/dashboard" className="flex items-center gap-2">
//             <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-purple-500/30 flex-shrink-0">
//               P
//             </div>
//             {!isCollapsed && (
//               <span className="text-xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-400 bg-clip-text text-transparent whitespace-nowrap">
//                 PromptHub
//               </span>
//             )}
//           </Link>
...
//                 <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-bold shadow-lg shadow-purple-500/30 flex-shrink-0">
//                   {user?.image?.[0] || user?.email?.[0] || "U"}
//                 </div>
...
//           ) : (
//             <div className="flex flex-col items-center gap-3">
//               <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-bold shadow-lg shadow-purple-500/30">
//                 {user?.image?.[0] || user?.email?.[0] || "U"}
//               </div>
//               <button
//                 onClick={handleLogout}
